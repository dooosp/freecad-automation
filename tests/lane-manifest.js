...
export const TEST_LANES = Object.freeze([
  Object.freeze({
    ...
    scope: 'config migration/validation, runtime path resolution, invocation assembly, structural validation, canonical package integrity, and Stage 5B no-evidence/audit/surrogate/source-preflight CLI smoke',
  ...
  Object.freeze({
    ...
    scope: 'local non-production CLI lane for source acquisition preflight, evidence review dry-run orchestration, inspection-evidence-intake, inspection-evidence-promotion-dry-run, stage5b-evidence-audit, and stage5b-surrogate-inspection-validation proving no genuine evidence is promoted',
    freecadRequired: false,
    steps: Object.freeze([
      Object.freeze({ label: 'Stage 5B no-evidence CLI lane', args: Object.freeze(['tests/stage5b-no-evidence-lane.test.js']) }),
      Object.freeze({ label: 'Stage 5B evidence review dry-run orchestration', args: Object.freeze(['tests/stage5b-evidence-review-dry-run.test.js']) }),
