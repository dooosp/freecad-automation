...
export const TEST_LANES = Object.freeze([
  Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ label: 'Studio shell bootstrap', args: Object.freeze(['tests/studio-shell-bootstrap.test.js']) }),
  ...
  Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ label: 'Studio shell browser smoke', args: Object.freeze(['tests/studio-shell-browser-smoke.test.js']) }),
