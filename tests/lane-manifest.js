...
export const TEST_LANES = Object.freeze([
  Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ label: 'Preliminary RFQ outreach authorization', args: Object.freeze(['tests/preliminary-rfq-outreach-authorization.test.js']) }),
      ...
      Object.freeze({ label: 'Studio beginner UX contract', args: Object.freeze(['tests/studio-beginner-ux-contract.test.js']) }),
      Object.freeze({ label: 'Studio responsive CSS', args: Object.freeze(['tests/studio-responsive-css.test.js']) }),
      Object.freeze({ label: 'Studio manufacturing robotics card', args: Object.freeze(['tests/studio-manufacturing-robotics-card.test.js']) }),
      ...
      Object.freeze({ label: 'Revision lineage shared contract', args: Object.freeze(['tests/revision-lineage-contract.test.js']) }),
      Object.freeze({ label: 'Revision lineage readiness propagation', args: Object.freeze(['tests/revision-lineage-readiness.test.js']) }),
      Object.freeze({ label: 'Revision lineage artifact propagation', args: Object.freeze(['tests/revision-lineage-propagation.test.js']) }),
      ...
      Object.freeze({ label: 'Manufacturing action demo profile', args: Object.freeze(['tests/manufacturing-action-demo-profile.test.js']) }),
      Object.freeze({ label: 'Manufacturing robotics portfolio', args: Object.freeze(['tests/manufacturing-robotics-portfolio.test.js']) }),
      Object.freeze({ label: 'Manufacturing robotics UAT contracts', args: Object.freeze(['tests/manufacturing-robotics-uat.test.js']) }),
  ...
  Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ label: 'Manufacturing action tracked job', args: Object.freeze(['tests/manufacturing-action-tracked-job.test.js']) }),
      Object.freeze({ label: 'Revision lineage tracked re-entry', args: Object.freeze(['tests/revision-lineage-reentry.test.js']) }),
      Object.freeze({ label: 'Revision lineage CLI integration', args: Object.freeze(['tests/revision-lineage-cli-integration.test.js']) }),
      ...
      Object.freeze({ label: 'Local API manufacturing robotics demo', args: Object.freeze(['tests/local-api-manufacturing-robotics-demo.test.js']) }),
