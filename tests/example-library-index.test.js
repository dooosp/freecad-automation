...
assert.match(rootReadmeText, /quality\/drawing evidence does not satisfy `inspection_evidence`/);
assert.match(rootReadmeText, /Studio supports tracked job\/artifact reopen/);
assert.match(rootReadmeText, /checked-in canonical package discovery is documented first today/);
