...
function buildLandingCopy(locale = 'en') {
  if (locale === 'ko') {
    return {
      title: 'fcad 로컬 API',
      language: '언어',
      intro: 'Studio가 기본 브라우저 작업 영역이며, 이 페이지는 그에 연결된 로컬 API와 보조 경로를 설명합니다.',
      ...
      executionModel: 'Studio의 미리보기와 추적 실행',
      previewLabel: '미리보기',
      ...
      parallelShell: 'Studio 우선 브라우저 경로',
      ...
      plainBrowserLanding: 'Studio가 기본 브라우저 작업 영역입니다. / 또는 /studio를 사용하세요.',
  ...
  return {
    ...
    language: 'Language',
    intro: 'Studio is the preferred browser workspace, and this page documents the supporting local API plus compatibility routes.',
    ...
    executionModel: 'How Studio handles preview and tracked work',
    ...
    parallelShell: 'Studio-first browser routing',
    ...
    plainBrowserLanding: 'Studio is the preferred browser workspace: use / or /studio.',
