...
## Branch
- `refactor/shared-i18n-contract-v2`
...
- Migrate server-side landing/static helpers to consume the shared contract directly.
...
- Do not claim manual browser smoke checks unless they actually ran.
