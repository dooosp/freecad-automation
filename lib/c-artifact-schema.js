...
const C_COMMAND_CONTRACTS = Object.freeze({
  ...
  'readiness-report': {
    ...
    notes: [
      ...
      'The --review-pack route is canonical; readiness-report <config> remains a legacy compatibility path and should not be presented as canonical D-backed provenance.',
    ],
  },
  ...
  'generate-standard-docs': {
    ...
    required_inputs: ['config', 'readiness_report'],
    optional_inputs: ['runtime', 'review_pack', 'process_plan', 'quality_risk'],
    derived_outputs: [
      'process_flow.md',
    ...
    notes: [
      ...
      'CLI callers must provide --readiness-report or --review-pack; config-only fallback does not qualify as canonical readiness input.',
      'When --review-pack is supplied, the CLI must build canonical readiness_report.json from that D artifact before generating docs.',
    ],
  },
  pack: {
    layer: 'C',
