...
export const C_CONTRACT_VERSION = 'c1';
...
const C_COMMAND_CONTRACTS = Object.freeze({
  'process-plan': {
    ...
    optional_inputs: ['review_pack'],
    derived_outputs: [],
    notes: [
      'Process-plan JSON is the machine-readable source of truth for this downstream C output.',
      'Do not move D scoring, linkage, or geometry logic into this command.',
    ],
  },
  'quality-risk': {
    layer: 'C',
  ...
  'readiness-report': {
    ...
    required_inputs: ['config'],
    optional_inputs: ['runtime', 'review_pack'],
  ...
  'stabilization-review': {
    ...
    required_inputs: ['config', 'runtime'],
    optional_inputs: ['review_pack'],
    derived_outputs: [],
    notes: [
