...
function buildStage5bCandidateGateReport(candidate, normalizedCandidatePath, rejections, generatedAt) {
  ...
  return {
    ...
    summary: {
      ...
      readiness_truth: 'unchanged: no evidence is attached; canonical packages remain needs_more_evidence / hold_for_evidence_completion until a later authorized promotion mutates them',
    },
    checklist,
