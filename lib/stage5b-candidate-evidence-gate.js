...
const READINESS_UNCHANGED_TRUTH = 'unchanged: no evidence is attached; canonical packages remain needs_more_evidence / hold_for_evidence_completion until a later authorized promotion mutates them';
...
function buildStage5bCandidateGateReport(candidate, normalizedCandidatePath, rejections, generatedAt) {
  ...
  return {
    ...
    decision: {
      ...
      reviewer_note: 'A passing candidate gate report is only a pre-intake eligibility signal; it is not evidence attachment, evidence promotion, or readiness satisfaction.',
    },
    checklist,
