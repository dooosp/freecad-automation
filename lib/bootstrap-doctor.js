...
const COMMAND_READS_IGNORED_OUTPUT_PATTERN = /^(?:cat|less|more|open|pbcopy|jq|tail|head|sed)\b[^`]*\b(?:output|\.ci|tmp\/codex|local\/(?:stage5b-candidate-evidence-inbox|inspection-evidence-quarantine))\//;
