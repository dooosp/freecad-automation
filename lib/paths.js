...
const DEFAULT_FREECAD_DIR = 'C:\\Program Files\\FreeCAD 1.0';
const ENV_FREECAD_DIR = typeof process.env.FREECAD_DIR === 'string'
  ? process.env.FREECAD_DIR.trim()
  : '';
export const FREECAD_DIR = ENV_FREECAD_DIR || DEFAULT_FREECAD_DIR;
