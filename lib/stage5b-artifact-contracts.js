...
const STAGE5B_ARTIFACT_SCHEMA_CATALOG = Object.freeze([
  ...
  Object.freeze({
    ...
    schema_path: null,
    location_pattern: 'docs/stage-5b-attachment-authorization-record.md or a later explicitly authorized private control record outside the repository root.',
    ...
    control_private_status: 'Control metadata template. Private authorization details and candidate records stay outside this file unless a later task explicitly authorizes a sanitized tracked record.',
