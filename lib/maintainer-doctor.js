...
const PRIVATE_PATH_PATTERN = /(^|[\s"'(=:])((?:\/Users|\/home|\/private|\/var)\/[^\s"'<>)]*)/g;
...
function sanitizeText(value) {
  return String(value || '')
    ...
    .replace(/\/private\/[^\s"'<>)]*/g, '/private/<redacted>')
    .replace(/\/var\/[^\s"'<>)]*/g, '/var/<redacted>')
...
function collectPreflight(projectRoot) {
  ...
  return {
    ...
    repo_identity_ok: basename(repoRoot) === 'freecad-automation' && packageJson.name === 'freecad-automation',
